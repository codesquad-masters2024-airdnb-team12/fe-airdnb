...
<div class="Accommodations justify-start gap-6">
  ...
  <div class="Info absolute w-[400px] h-full left-[380px] top-[4px] absolute flex-col justify-start items-start gap-2 inline-flex">
    ...
    <div class="Option w-full text-zinc-500 text-sm font-normal font-['Noto Sans KR']">최대 인원 {accommodation.maxGuests}명 ∙ {accommodation.accommodationType} ∙ 침대 {accommodation.bed}개 ∙ 욕실 {accommodation.bath}개<br/>
      {#each accommodation.facilities as facility}
        {facility.name}
        <!--{#if facility}-->
        <!--   ∙ {facility.name}-->
        <!--{/if}-->
